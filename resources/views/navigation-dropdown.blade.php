<nav x-data="{ open: false }" class="navbarWrap">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('dashboard.devices') }}" :active="request()->routeIs('dashboard.devices')">
                        {{ __('Devices') }}
                    </x-jet-nav-link>
...
{{--                        </x-jet-dropdown-link>--}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('dashboard.devices') }}" :active="request()->routeIs('dashboard.devices')">
                {{ __('Devices') }}
            </x-jet-responsive-nav-link>
