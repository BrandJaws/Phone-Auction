    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sm:pb-0">
        <div class="boxPanel py-6 px-6 bg-white rounded-lg mt-10">
            <table class="table-auto w-9/12">
                ...
                <th class="px-4 py-2  w-3/12 text-left">Order Type</th>
                <th class="px-4 py-2 w-3/12 text-right">Action</th>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">{{ $sellOrder->selfDropToLocation ? 'Mail' : 'Drop At Store' }} </td>
