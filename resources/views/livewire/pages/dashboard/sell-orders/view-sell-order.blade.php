                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <div class="sellerInfo">
                        <form method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" wire:submit.prevent="" >
                            @if($selfDropLocationName)
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                        <label  class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"  for="paymentMethod" >{{ __('Drop Location') }}</label>
                                        <input id="paymentMethod"  class="appearance-none block w-full bg-gray-200 text-gray-700 border-2 border-gray-200 rounded py-2 px-4 leading-tight"  type="text" required autocomplete="paymentMethod" wire:model.lazy="selfDropLocationName" readonly/>
