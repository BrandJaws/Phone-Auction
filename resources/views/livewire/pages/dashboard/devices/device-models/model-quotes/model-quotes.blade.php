            ...
            <table class="table-auto w-7/12">
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2 text-right">
                        <a class="text-sm bg-white btnSmall hover:bg-white-700 text-black border border-gray-400 font-bold py-2 rounded" href="{{route('dashboard.devices.models.quotes.edit', ["device_id" => $device->id, "device_model_id" => $modelQuote->id, "model_quote_id" => $modelQuote->id])}}"> Edit </a>
